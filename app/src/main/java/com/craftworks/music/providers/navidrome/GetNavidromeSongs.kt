...
fun parseNavidromeSearch3JSON(
    ...
    subsonicResponse.searchResult3?.song?.map {
        ...
        it.imageUrl = "$navidromeUrl/rest/getCoverArt.view?&id=${it.navidromeID}&u=$navidromeUsername&t=$passwordHashMedia&s=$passwordSaltMedia&v=1.16.1&c=Chora&size=512"
    }
